...
/**
 * @author zcm
 * @ClassName: MyActionSheetDialog
 * @Description: 仿IOS弹框效果
...
public class MyActionSheetDialog implements OnClickListener {
    ...
    public MyActionSheetDialog builder() {
        ...
        View view = LayoutInflater.from(context).inflate(
                R.layout.view_dialog_myactionsheet, null);
    ...
    private void setSheetItems() {
        ...
        for (int i = 1; i <= size; i++) {
            ...
            if(size == 1){
                textView.setBackgroundResource(R.drawable.actionsheet_btn_round_selector);
            }else if(size == 2){
                textView.setBackgroundResource(i==1?R.drawable.actionsheet_btn_top_round_selector:R.drawable.actionsheet_btn_bottom_round_selector);
            }else{
                if(i==1){
                    textView.setBackgroundResource(R.drawable.actionsheet_btn_top_round_selector);
                }else if(i == size){
                    textView.setBackgroundResource(R.drawable.actionsheet_btn_bottom_round_selector);
                }else{
