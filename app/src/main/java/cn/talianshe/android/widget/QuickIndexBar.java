...
public class QuickIndexBar extends View {
    ...
    private int textSize = DensityUtils.spTopx(getContext(),12);
...
//        super.onMeasure(widthMeasureSpec, heightMeasureSpec);
        ...
        if(widgetWidth == 0)
            widgetWidth= getLargetTextWidth() + getPaddingLeft()+getPaddingRight()+getPaddingStart()+getPaddingEnd();
        setMeasuredDimension(widgetWidth,heightMeasureSpec);
    }
     ...
     * @return
     */
    private int getLargetTextWidth() {
        int width = 0;
